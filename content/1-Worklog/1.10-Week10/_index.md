...
* Build a detailed description of the group project topic.
* Sketch the architecture diagram and refine the initial connection flows.
...
* Designed a detailed architecture diagram for the Playwright Automation Testing system (including CloudFront, S3, Cognito, API Gateway, SQS, ECS Fargate, ECR, DynamoDB, Lambda, CloudWatch, Secrets Manager, VPC, SES).
* Researched and adjusted secure data flows from clients through CloudFront and S3 to backend systems.
* Sketched and test-connected services according to the architecture diagram, identifying and discussing illogical areas with the team for adjustment.
