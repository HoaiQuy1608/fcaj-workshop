...
| Thứ&nbsp;Tư | - Thực hành Lab 58 (Module 02) về Amazon Systems Manager Session Manager. <br> - Đã tạo Public Linux EC2 và Private Windows EC2, gán IAM Role, tạo các VPC Endpoints để kết nối EC2 private bằng Session Manager. <br> - Gặp lỗi Private Windows EC2 không hiện trong Managed Nodes do security group của endpoint thiếu rule inbound HTTPS 443. <br> - sau khi bổ sung rule thì kết nối thành công và kiểm tra bằng lệnh ipconfig. <br> - Thực hành Lab 27 về quản lý tài nguyên bằng Tag và Resource Group để phân loại tài nguyên theo dự án nhóm và cleanup hiệu quả. | 13/05/2026 | 13/05/2026 | [awsstudygroup.com (Lab 58)](https://000058.awsstudygroup.com/vi/) - <br> [awsstudygroup.com (Lab 27)](https://000027.awsstudygroup.com/vi/) |
| Thứ&nbsp;Năm | - Thực hành Lab 04 về Amazon EC2. <br> - Triển khai tạo Windows EC2 và Linux EC2, cấu hình Security Group để kết nối RDP/SSH, tải file Remote Desktop và kết nối thành công vào Windows EC2. <br> - Thực hành các thao tác quản lý EC2 như thay đổi cấu hình instance, tạo Snapshot, tạo Custom AMI và khởi chạy instance mới từ AMI. | 14/05/2026 | 14/05/2026 | [awsstudygroup.com (Lab 4)](https://000004.awsstudygroup.com/vi/) |
